/**
 * This class controls the graphical SolarSystem interface and accompanying objects for the Milky Way solar system.
 * @author Will Holbrook
 */
public class Driver {
    public static final int SYSTEM_WIDTH = 1200; // WIDTH FOR THE WINDOW
    public static final int SYSTEM_HEIGHT = 1000; // HEIGHT FOR THE WINDOW
    public static final int ASTEROID_AMOUNT = 250; // AMOUNT OF ASTEROIDS IN THE ASTEROID FIELD
    public static final int ASTEROID_MIN_DISTANCE = 270; // LOWER BOUND FOR THE ASTEROID FIELD
    public static final int ASTEROID_MAX_DISTANCE = 310; // HIGHER BOUND FOR THE ASTEROID FIELD

    public static void main(String[] args) {
        // CREATE SOLAR SYSTEM WINDOW
        SolarSystem milkyWay = new SolarSystem(SYSTEM_WIDTH, SYSTEM_HEIGHT);
        // SUN
        Sun sun = new Sun(milkyWay, 0, 0, 50, "#F9AE28");
        // PLANETS
        Planet mercury = new Planet(milkyWay, 80, 0, 15, "#C2B396", 1.60745467);
        Planet venus = new Planet(milkyWay, 100, 0, 25, "#DBAB3F", 1.17595702);
        Planet earth = new Planet(milkyWay, 150, 0, 37, "#0C0E3F", 1);
        ...
        // MOONS
        Moon earthMoon = new Moon(milkyWay, earth, 32, 0, 10, "GREY", 0, earth.getDistance(), 3.4295302);
        ...
        // MOVE OBJECTS INTO ARRAYS FOR CONCISE HANDLING
        ...
        // DRAW LOOP FOR THE OBJECTS IN THE GRAPHICAL SOLAR SYSTEM
        while (true) {
            sun.draw();
            ...
            milkyWay.finishedDrawing(); // REDRAW AFTER UPDATING THE OBJECTS ETC
        }
    }
}
